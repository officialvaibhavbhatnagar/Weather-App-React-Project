...
<input
                  ...
                  style={{ fontSize: '28px' ,width: '600px', background: '#FFFFFF', boxShadow: '0px 4px 32px rgba(143, 143, 143, 0.4)', borderRadius: '4px', color: '#8C8C99' , boxSizing: 'border-box', borderRadius: '4px', padding: '5px'}}
									onChange={e => this.updateCityName(e)}
								/>  
    <button 
       onClick={this.handleSearchInput}
       style={{ background: '#6500F2', color: 'white', fontSize: '33px',cursor: 'pointer' ,margin:'2px', boxShadow: '0px 4px 32px rgba(143, 143, 143, 0.4)', borderRadius: '4px',}}
